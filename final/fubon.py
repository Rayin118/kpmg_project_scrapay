...
data_files = [
    ...
    ('北海布蘭特原油現貨價_週.csv', '131670'),
    ('苯乙烯單體韓國現貨_週.csv', '130770'),
    ('PVC_進口價_週.csv','130160'),
    ('EVA_台塑吹膜級_月.csv','130890'),
    ('SM_海灣區_現貨_週.csv','130190'),
    ('ABS聚合物(注塑)_中國到岸價_週.csv','130041'),
    ('HDPE基準價.csv','132120'),
    ('LDPE基準價_週.csv','132110'),
    ('LLDPE基準價_週.csv','132130'),
    ('PP市場價_週.csv','132150'),
    ('CPL進口價_週.csv','140140'),
    ('橡膠新加坡RSS3近期價.csv','210150')
]
